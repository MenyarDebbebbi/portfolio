  ...
  const services = [
    {
      ...
      description:
        'Backend Development with "SpringBoot", "Symfony5", and ".Net".',
      role: "Web Developer",
    },
    {
      img: gil,
      ...
      description:
        'Building responsive and interactive interfaces with "React" and "Vue.js".',
    ...
    },
    {
      ...
      description:
        'Creating mobile applications using "React Native" and "Flutter".',
